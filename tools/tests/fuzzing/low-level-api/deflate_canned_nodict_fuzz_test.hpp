 ...
 ******************************************************************************/
#ifndef QPL_TOOLS_TESTS_FUZZING_LOW_LEVEL_API_DEFLATE_CANNED_NODICT_FUZZ_TEST_HPP
...
static inline int deflate_canned_nodict_fuzz(const uint8_t* Data, size_t Size, qpl_compression_levels compression_level,
