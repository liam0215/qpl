...
#ifndef QPL_SOURCES_C_API_FILTER_OPERATIONS_ANALYTICS_STATE_T_H
#define QPL_SOURCES_C_API_FILTER_OPERATIONS_ANALYTICS_STATE_T_H
...
#endif //QPL_SOURCES_C_API_FILTER_OPERATIONS_ANALYTICS_STATE_T_H
/** @} */
