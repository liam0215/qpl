...
#ifndef QPL_SOURCES_CORE_SW_INCLUDE_QPLC_COMPRESSION_CONSTS_H
#define QPL_SOURCES_CORE_SW_INCLUDE_QPLC_COMPRESSION_CONSTS_H
...
#endif //QPL_SOURCES_CORE_SW_INCLUDE_QPLC_COMPRESSION_CONSTS_H
